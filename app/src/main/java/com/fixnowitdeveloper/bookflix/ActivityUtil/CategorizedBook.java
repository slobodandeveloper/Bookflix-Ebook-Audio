...
import com.fixnowitdeveloper.bookflix.AdapterUtil.BookAdapter;
...
public class CategorizedBook extends AppCompatActivity implements View.OnClickListener, ConnectionCallback {
    private String TAG = CategorizedBook.class.getName();
    ...
    private void getIntentData() {
        ...
        category = getIntent().getStringExtra(Constant.IntentKey.CATEGORY);
        categoryId = getIntent().getStringExtra(Constant.IntentKey.CATEGORY_ID);
    ...
    private void initUI() {
        ...
        Utility.Logger(TAG, "Setting = Category " + category + " Category Id " + categoryId);

        txtMenu = findViewById(R.id.txt_menu);
        txtMenu.setText(category);
    ...
    private String getJson() {
        ...
        try {
            ...
            jsonObject.accumulate("functionality", "categorized_book");
            jsonObject.accumulate("cat_id", categoryId);
