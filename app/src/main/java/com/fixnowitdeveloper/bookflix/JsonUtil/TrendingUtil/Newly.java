...
package com.fixnowitdeveloper.bookflix.JsonUtil.TrendingUtil;
...
public class Newly implements Parcelable
{
    ...
    public Newly setRating(String rating) {
        this.rating = rating;
        return this;
    }
    ...
    public Newly setBookUrl(String streamUrl) {
    ...
    public Newly setFbUrl(String fbUrl) {
        this.fbUrl = fbUrl;
        return this;
    }
    ...
    public Newly setTwitterUrl(String twitterUrl) {
    ...
    public Newly setWebUrl(String webUrl) {
        this.webUrl = webUrl;
        return this;
    }
    ...
    public static final Creator<Newly> CREATOR = new Creator<Newly>() {
        @Override
        public Newly createFromParcel(Parcel source) {
            return new Newly(source);
        }

        @Override
        public Newly[] newArray(int size) {
            return new Newly[size];
        }
    };
}
